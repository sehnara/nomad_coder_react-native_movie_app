...
const Tabs = ()=>{
    ...
    <Tab.Screen name="Tv" component={Home} options={{tabBarBadge:7, tabBarIcon : ({focused, color, size})=> {
        return <Ionicons name = "home" size={size} color = {color}/>
    }}}/>
    <Tab.Screen name="Search" component={Tv} options={{tabBarIcon : ({focused, size, color})=> <Ionicons name="tv" size={size} color={color}/>}}/>
    </Tab.Navigator>)
}
