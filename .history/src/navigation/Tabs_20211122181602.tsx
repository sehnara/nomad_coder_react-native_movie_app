...
const Tabs = ()=>{
    ...
    return(<Tab.Navigator screenOptions={{ tabBarStyle : {backgroundColor : isDark ? 'black':'white'} ,headerShown : false, tabBarActiveTintColor : "red", tabBarInactiveTintColor:"green", }}>
